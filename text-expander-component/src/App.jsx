  ...
  return (
    <div>
      <TextExpander>
        ...
        worlds. the stuff of dreams and science fiction, but believe it or not, space travel is a
        real thing. Humans and robots are constantly venturing out into the cosmos to uncover its
        secrets and push the boundaries of whats possible.
      </TextExpander>
      ...
      >
        ...
        private companies, and international space organizations. And while its not always easy (or
      ...
      <TextExpander expanded={true} className="box">
        ...
        about. Who knows what ll discover next!
      </TextExpander>
    </div>
  );
}
...
function TextExpander({
  ...
  return (
    <div className={className}>
      <span>{children}</span>
      <button style={{ color: buttonColor }} onClick={() => setIsExpanded(!isExpanded)}>
